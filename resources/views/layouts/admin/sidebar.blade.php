...
>
    ...
    <li
        class="nav-item {{ request()->routeIs('dashboard.createEvent') ? 'active' : '' }}"
    >
    ...
    <li
        class="nav-item {{ request()->routeIs('dashboard.ticket') ? 'active' : '' }}"
    >
    ...
    <li class="nav-item {{ request()->routeIs('password') ? 'active' : '' }}">
